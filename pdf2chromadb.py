...
chromaCollectionName = "PDF-Collection"
chromaPersist_directory = "src/chromaDB"
chromaImportDir = "./pdfs/"
...
if __name__ == "__main__":
    ...
    # Step 1: Parse PDF
    files = os.listdir(chromaImportDir)
    file_paths = [file for file in files if file.endswith('.pdf')]

    for file_path in file_paths:
        pdf_file_with_path = chromaImportDir+"/"+file_path

        raw_pages, metadata = parse_pdf(pdf_file_with_path)
        ...
        vector_store = Chroma.from_documents(
            ...
            persist_directory=chromaPersist_directory,
        )
